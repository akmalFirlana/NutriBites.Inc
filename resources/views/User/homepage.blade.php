...
<section class="header tw-min-h-screen" style="background-color: #F2F0F1; overflow: hidden; position: relative">
    <div class="" style="margin-left: 7rem;">
        ...
        <button class="btn slide-in-right" style="border-radius: 25px; background-color: #01AB31; color:
         white; padding: 1rem 3rem; font-size: 1.5rem; font-weight: 500" onclick="window.location.href='/daftar'">Bergabung</button>
    ...
    <div class="row justify-content-between" style="margin: 0 7rem">
        <div class="col-sm-3 procard tw-rounded-3xl" >
            <div class="card shadow position-relative" style="border-radius: 12px">
                ...
                <div onclick="location.href='{{ route('app') }}';" class="card-footer border-top border-gray-300 p-4">
