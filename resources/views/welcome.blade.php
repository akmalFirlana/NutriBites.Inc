...
<div class="container">
    ...
    <form id="multiStepForm">
        ...
        <div class="form-page" id="page1">
            <h2>Halaman 1: Data Akun</h2>
            <label for="email">Email:</label>
            <input type="email" name="email" id="email" required>
            <label for="password">Password:</label>
            <input type="password" name="password" id="password" required>
            <button type="button" onclick="nextPage(2)">Selanjutnya</button>
        </div>


        <div class="form-page" id="page2" style="display: none;">
            <h2>Halaman 2: Data Pribadi</h2>
            <label for="name">Nama:</label>
            <input type="text" name="name" id="name" required>
            <label for="store_name">Nama Toko:</label>
            <input type="text" name="store_name" id="store_name" required>
            <button type="button" onclick="previousPage(1)">Kembali</button>
            <button type="button" onclick="nextPage(3)">Selanjutnya</button>
        </div>

        <div class="form-page" id="page3" style="display: none;">
            <h2>Halaman 3: Lokasi Toko</h2>
            <label for="location">Lokasi:</label>
            <input type="text" name="location" id="location" required>
            <button type="button" onclick="previousPage(2)">Kembali</button>
